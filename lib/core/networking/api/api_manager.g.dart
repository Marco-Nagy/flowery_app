...
class _ApiManager implements ApiManager {
  ...
  Future<VerifyResetCodeResponseDto> verifyResetCode(
    VerifyResetCodeRequestDto resetCode,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  Future<ResetPasswordResponseDto> resetPassword(
    ResetPasswordRequestDto resetPassword,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  Future<GenericResponseDto> getGenericProduct(String resourceName) async {
    ...
    final _options = _setStreamType<GenericResponseDto>(
  ...
  Future<GetAllCategoriesResponseDto> getAllCategories() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<GetAllCategoriesResponseDto>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'api/v1/categories',
  ...
  Future<HomeResponseModelEntity> getHome() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<HomeResponseModelEntity>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'api/v1/home',
  ...
  Future<BestSellerResponseModelEntity> getMostSellingProducts() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<BestSellerResponseModelEntity>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'api/v1/best-seller',
  ...
  Future<AddToCartResponseDto> addProductToCart(
    AddProductToCartRequestDto body,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  Future<UploadPhotoResponseDto> uploadPhoto(File photo) async {
    ...
    final _options = _setStreamType<UploadPhotoResponseDto>(
      Options(
        method: 'PUT',
        headers: _headers,
        extra: _extra,
  ...
  Future<OrderResponseDto> getUserOrders() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<OrderResponseDto>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'api/v1/orders',
