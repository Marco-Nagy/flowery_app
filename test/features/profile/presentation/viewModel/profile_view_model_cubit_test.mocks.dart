...
// in flowery_store/test/features/profile/presentation/viewModel/profile_view_model_cubit_test.dart.
...
class MockProfileUseCase extends _i1.Mock implements _i2.ProfileUseCase {
  MockProfileUseCase() {
...
///
/// See the documentation for Mockito's code generation for more information.
class MockOfflineDataSource extends _i1.Mock implements _i12.OfflineDataSource {
  MockOfflineDataSource() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i3.Future<void> cacheToken(String? token) =>
      (super.noSuchMethod(
  ...
  @override
  _i3.Future<void> deleteCachedToken() =>
      (super.noSuchMethod(
            Invocation.method(#deleteCachedToken, []),
            returnValue: _i3.Future<void>.value(),
            returnValueForMissingStub: _i3.Future<void>.value(),
          )
          as _i3.Future<void>);
