...
// in flowery_e_commerce/test/features/product/data/repositories/product_repo_impl_test.dart.
...
/// A class which mocks [ProductOnlineDataSource].
///
/// See the documentation for Mockito's code generation for more information.
class MockProductOnlineDataSource extends _i1.Mock
    implements _i2.ProductOnlineDataSource {
  MockProductOnlineDataSource() {
  ...
  _i3.Future<_i4.DataResult<_i5.ProductResponseEntity>> getAllProducts({
    String? keyword,
      ...
      (super.noSuchMethod(
            Invocation.method(#getAllProducts, [], {#keyword: keyword}),
            returnValue:
